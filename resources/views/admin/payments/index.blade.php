                            ...
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                <thead class="text-center">
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 154px;">Tên phương thức thanh toán</th>
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td @if ($loop->last) class="" @else class="text-center" @endif>
                                            <form method="POST" action="{{ route('admin.payments.delete', ['slug' => $payment->slug]) }}">
                                                @csrf
                                                @method('DELETE')
                                                <a href="{{ route('admin.payments.edit', ['slug' => $payment->slug]) }}"><button type="button" class="btn btn-primary mb-1">Sửa<i class="ml-1 fas fa-edit"></i></button></a>
