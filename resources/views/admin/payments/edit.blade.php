...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                <form class="col-xl-4 col-lg-5 col-md-6 col-12" method="POST" enctype="multipart/form-data" action="{{ route('admin.payments.update', ['id' => $payment->id]) }}">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label>Tên đơn vị</label>
                        <input type="text" name="name" class="form-control" placeholder="Nhập tên đơn vị" value="{{ old('name') ?? $payment->name }}">
                        @error("name")
