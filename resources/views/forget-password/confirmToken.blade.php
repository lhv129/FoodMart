                ...
                <div class="col-12 col-lg-10 col-xl-8">
                    <div class="row gy-5 justify-content-center">
                        <div class="col-12 col-lg-5">
                            <form method="POST" action="{{ route('handle.confirm.forget') }}">
                                @csrf
                                @method('POST')
                                <div class="row gy-3 overflow-hidden">
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control border-0 border-bottom rounded-0" name="token"
                                                value="{{ old('token') }}">
                                            <label for="token" class="form-label">Vui lòng nhập mã khôi phục</label>
                                            @error('token')
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn btn-lg btn-dark rounded-0 fs-6" type="submit">Tiếp tục</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
